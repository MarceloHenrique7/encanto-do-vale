...
// Catálogo publicado. Alterações do editor local devem ser exportadas para este arquivo.
...
export const products: Product[] = [
  ...
  {
    "id": "bolo-de-pote-nutella",
    "name": "Bolo de Pote Nutella Premium",
    "description": "Delicioso bolo de pote com camadas generosas de bolo macio, creme de Nutella e finalização irresistível. Perfeito para entrega rápida e sem complicações. Você pode personalizar adicionando seus toppings favoritos!",
    "price": "R$ 14,99",
    "basePrice": 14.99,
    "imageSrc": "https://i.ibb.co/s98VxTkL/Sobremesa-deliciosa-com-Nutella-e-chocolate.png",
    "fulfillmentType": "entrega-pronta",
    ...
    "extras": [
      {
        "id": "morango",
        "label": "Morango fresco",
        "price": 3.50
      },
      {
        "id": "leite-condensado",
        "label": "Calda de leite condensado",
        "price": 2.00
      },
      {
        "id": "chocolate-granulado",
        "label": "Chocolate granulado",
        "price": 1.50
      },
      {
        "id": "ninho-pó",
