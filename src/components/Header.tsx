...
const carouselItems = [
  { id: 'slide-1', title: 'Bolos de Casamento', subtitle: 'Tornando um momento inesquecível', imageSrc: 'https://i.ibb.co/Tqw5Vr70/Chat-GPT-Image-5-de-abr-de-2026-18-16-30.png' },
    ...
    <header className="hero mb-10">
      ...
      >
        ...
        <div className="header-carousel-stage">
          ...
          <div className="header-carousel-dots" role="tablist" aria-label="Selecionar destaque">
            {carouselItems.map((item, index) => (
              <button
                key={item.id}
                type="button"
