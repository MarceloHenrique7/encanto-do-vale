...
export const products: Product[] = [
  {
    ...
    isFeatured: false,
    isPromo: true,
    primaryCategoryLabel: 'Dia das Maes',
    categoryIds: ['dia-das-maes'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Cesta sofisticada para surpreender, reunindo chocolates especiais, itens presenteaveis e um ursinho em uma montagem caprichada.',
